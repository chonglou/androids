...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE items(id INTEGER PRIMARY KEY AUTOINCREMENT, feed INTEGER NOT NULL, link VARCHAR(255) NOT NULL, title VARCHAR(255) NOT NULL, description TEXT NOT NULL, pubDate char(32) NOT NULL, created TIMESTAMP DEFAULT CURRENT_TIMESTAMP)");
